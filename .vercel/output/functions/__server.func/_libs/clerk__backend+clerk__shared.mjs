...
var getEnvVariable = (name, context) => {
	...
	if (typeof import.meta !== "undefined" && typeof {
		...
		"VITE_CLERK_PUBLISHABLE_KEY": "pk_test_ZGVzaXJlZC1jYXRmaXNoLTkxLmNsZXJrLmFjY291bnRzLmRldiQ",
		"VITE_CONVEX_SITE_URL": "https://modest-chihuahua-994.convex.site",
		"VITE_CONVEX_URL": "https://modest-chihuahua-994.convex.cloud"
	}[name] === "string") return {
		"BASE_URL": "/",
		"DEV": false,
		"MODE": "production",
...
//#endregion
//#region node_modules/@clerk/backend/dist/chunk-7E7A3JZN.mjs
...
//#endregion
//#region node_modules/@clerk/backend/dist/chunk-VJDTWTY2.mjs
...
var API_VERSION = "v1";
var USER_AGENT = `@clerk/backend@3.9.0`;
...
var OAuthApplicationsApi = class extends AbstractAPI {
	...
	async revokeToken(params) {
		...
		return this.request({
			method: "POST",
			path: joinPaths(basePath22, oauthApplicationId, "revoke_token"),
			bodyParams
		});
	}
};
	...
	*/
	async getToken(sessionId, template, expiresInSeconds) {
		...
		const requestOptions = {
			method: "POST",
			path: template ? joinPaths(basePath28, sessionId, "tokens", template) : joinPaths(basePath28, sessionId, "tokens")
		};
...
//#endregion
export { getEnvVariable as A, LOCAL_ENV_SUFFIXES as C, deprecated as D, STAGING_ENV_SUFFIXES as E, ClerkRuntimeError as M, isAutomatedEnvironment as O, LOCAL_API_URL as S, STAGING_API_URL as T, createDevOrStagingUrlCache as _, constants as a, parsePublishableKey as b, getAuthObjectForAcceptedToken as c, isHttpOrHttps as d, isProxyUrlRelative as f, retry as g, addClerkPrefix as h, AuthStatus as i, buildErrorThrower as j, isDevelopmentEnvironment as k, createCheckAuthorization as l, proxyUrlToAbsoluteURL as m, eventMethodCalled as n, createClerkRequest as o, isValidProxyUrl as p, isTruthy as r, debugRequestState as s, createClerkClient as t, resolveAuthState as u, isDevelopmentFromPublishableKey as v, PROD_API_URL as w, LEGACY_DEV_INSTANCE_SUFFIXES as x, isDevelopmentFromSecretKey as y };
