...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D0sGsXeU.mjs");
...
var manifest = { "946c77cb015d3af369324ebdb693c583b25d59a10ba5ec676db9a45c5b74da4a": {
	functionName: "checkAuth_createServerFn_handler",
	importer: () => import("../_authenticated-BzPE0_Zg.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D_xSbGkF.mjs"),
		import("./start-kZOaA3Sn.mjs"),
